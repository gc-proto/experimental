...
<div class="row">
  <div class="col-md-8">
    ...
    <p class="mrgn-tp-lg"><strong>Let's slay the DataTable dragon!</strong></p>
...
{% endraw %}
    ...
    <ol class="lst-spcd">
      ...
      <li>Retrieve the files from your branch (the links below are to the main branch)
        <ul>
...
{% endraw %}
      ...
      <li>Validate the JSON file at <a href="https://jsonlint.com/">JSONLint</a> (or use the validator of your choice).  You'll have to remove the "---" at ther top of the file for it to validate.  Remember, it needs to be included when you publish the file.
        <div class="mrgn-tp-md">
          <p>For validation</p>
          <pre><code>{% raw %}
{
