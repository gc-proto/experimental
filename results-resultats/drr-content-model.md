...
<div class="mwsgeneric-base-html parbase section">
  ...
  <p>Copy the code from the working examples:</p>
    <ul class="list-unstyled">
      ...
      <p><a class="btn btn-default btn-lg" href="https://github.com/gc-proto/experimental/blob/master/results-resultats/drr-full-page.md">Full  report page code</a></li>
    </ul>  
