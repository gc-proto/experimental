...
<p class="mrgn-tp-lg mrgn-bttm-lg col-sm-4"><a href="https://test.canada.ca/experimental/results-resultats/drr-at-glance.html" class="btn btn-primary btn-lg" role="button">Read a summary of the Departmental results report</a></p>
<p class="mrgn-tp-lg mrgn-bttm-lg col-sm-4"><a onclick="window.print()" class="btn btn-default btn-lg mrgn-tp-md" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print this page</a></p>
</section>
...
<div class="table-responsive"><table id="tbl7" class="table table-bordered table-condensed">
  <thead>
    <tr class="active">
      ...
      <th class="text-left" scope="col"><div class="mrgn-tp-md mrgn-rght-md mrgn-bttm-md mrgn-lft-md">[Fiscal year] planneds</div></th>
