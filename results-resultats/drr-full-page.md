...
<p class="mrgn-tp-lg mrgn-bttm-lg mrgn-lft-md"><a href="https://test.canada.ca/experimental/results-resultats/drr-at-glance.html" class="btn btn-primary btn-lg" role="button">Read a summary of the Departmental results report</a><a href="#" onclick="window.print()" class="btn btn-default btn-lg mrgn-tp-sm" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print this page</a></p>
</section>
