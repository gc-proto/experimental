...
---
<h1 property="name" id="wb-cont" dir="ltr"><span class="stacked"><span>Page feedback tool</span>: <span>Canada.ca design</span></span></h1>
<p class="small">Last updated: 2023-03-31</p>
...
<img src="../images/page-feedback.png" class="img-responsive pattern-demo" alt=""> <img src="../images/page-feedback-detail.png" class="img-responsive pattern-demo" alt="">
<details>
...
<section>
  ...
  <ul>
    ...
    <li>understand if new pages are meeting user needs </li>
  ...
  <p><a href="https://test.canada.ca/experimental/design-system/performance/feedback/when.html#not">Additional behaviours to avoid when analyzing feedback.</a></p>
      ...
      <div class="col-md-12">
        ...
        <details>
          ...
          <ol class="lst-spcd">
            ...
            <li>Update the values of the hidden input  fields with the information specific to your implementation.
              <ul>
              ...
              <p>These hidden fields are for: <span class="bg-warning"><strong>Important note!</strong></span> Institution, Theme, Section values should be the SAME in English and French.</p>
            </li>
      ...
      <div class="col-md-12">
        ...
        <details>
          ...
          <ol class="lst-spcd">
            ...
            <li>
              <p>Update the values of the hidden input  fields with the information specific to your implementation. </p>
              <p>These hidden fields are for:</p>
              <ul>
                <li>Institution (your department acronym) - required</li>
                <li>Theme - required</li>
                <li>Section (a section of your website) - required but can be left blank</li>
              ...
              <p><span class="bg-warning"><strong>Important note!</strong></span> Institution, Theme, Section values should be the SAME in English and French.</p>
            </li>
            <li>Add the Javascript just above the closing /body tag</li>
            <li class="mrgn-bttm-lg">When someone submits a comment, they will see a checkmark icon and a thank you message.  If you do not see a checkmark, you may need to include a reference to the Font Awesome icon catalog in your page header.
              <pre class="prettyprint"><code>
...
<section>
  ...
  <div class="row">
    <div class="col-md-4 col-sm-6 col-xs-12">
      <p><a href="https://github.com/canada-ca/design-system-systeme-conception/issues" class="btn btn-default btn-block"><span class="fab fa-github"></span> Report an issue in github</a></p>
      <p><a href="" class="btn btn-default btn-block"><span class="fab fa-slack"></span> Join the conversation on slack</a></p>
    </div>
  </div>
</section>
