...
<div class="home"> 
  ...
  <div class="row">
    ...
    <div id="result2" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        ...
        <div class="panel-body">
          <p class="mrgn-tp-md">To provide basic background information about a program, you can use the <a href="https://design.canada.ca/recommended-templates/program-description-pages.html">Program description page</a>.</p>
    ...
    <div id="result8" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        ...
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/recommended-templates/guidance-legislation-pages.html">Guidance on legislation profile pages</a>.</p>
        </div>
      </section>
    </div>
    ...
    <div id="result14" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Search for your institution</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">Search for your organization in the list below to find out which profile to use.</p>
          <table class="wb-tables table table-striped table-hover small" data-wb-tables="{ &quot;ordering&quot; : false , &quot;paging&quot; : false }">
            <thead>
              <tr class="active">
                <th scope="col">Display name</th>
    ...
    <div id="result15" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Partnering/collaborative arrangement</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">If your organization is a partnering/collaborative arrangement as defined by the FIP glossary, use the <a href="https://design.canada.ca/recommended-templates/partnering-collaborative-arrangement-profile-pages.html">Partnering and collaborative arrangement profile page</a>.</p>
        </div>
      </section>
    </div>
    <div id="result16" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Contact information</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use one of the <a href="https://design.canada.ca/recommended-templates/contact-us-pages.html">Contact us pages</a>.</p>
    ...
    <div id="result17" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Ministers</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">Use the <a href="https://design.canada.ca/mandatory-templates/ministerial-profile-pages.html">Ministerial profile template</a>.</p>
        </div>
      </section>
    </div>
    <div id="result18" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Performance reporting</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/recommended-templates/institutional-service-performance-reporting-pages.html">Institutional service performance reporting page</a>.</p>
        </div>
      </section>
    </div>
    <div id="result19" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Topics</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">Use the <a href="https://design.canada.ca/mandatory-templates/topic-pages.html">topic page</a>.</p>
    ...
    <div id="result20" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Campaign page</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/recommended-templates/campaign-pages.html">Campaign page</a>.</p>
        </div>
      </section>
      <div class="mrgn-tp-lg">
        <ul class="list-inline">
          <li><a href="pattern-library-wizard-02.html" class="btn btn-lg btn-primary">Ask another question</a></li>
          <li><a href="pattern-library-01.html">Done</a></li>
        </ul>
      </div>
    </div>
    <div id="result21" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Promotional event</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/recommended-templates/promotional-events-pages.html">Promotional events page</a>.</p>
        </div>
      </section>
    </div>
    <div id="result22" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Related pages</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">If you need the user to navigate to related pages, you can use one of the following patterns: </p>
          <ul>
    ...
    <div id="result23" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Promotions</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">Promotions work best in context, where it relates to the content of the page.</p>
    ...
    <div id="result24" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Contact information</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/common-design-patterns/contact-information.html">Contact information</a> design pattern.</p>
        </div>
      </section>
    </div>
    <div id="result25" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Visual patterns</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use one of the following design patterns:</p>
          <ul>
    ...
    <div id="result26" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Consultations</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/recommended-templates/consultations-page.html">consultation template</a>.</p>
        </div>
      </section>
    </div>
    <div id="result27" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Results of a consultation</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">There are no specific template to publish a report of the results of a consultation. Use the appropriate patterns from the <a href="/en/government/about/design-system/pattern-library.html">Template and pattern library</a>.</p>
        </div>
      </section>
    </div>
    <div id="result28" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Consultations</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">If you want to launch a Promotional campaign about the consultation or the results of a consultation:</p>
          <ul>
    ...
    <div id="result29" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> In-page table of contents</h2>
        </header>
        <div class="panel-body">
    ...
    <div id="result30" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Expandable/collapsible content</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/common-design-patterns/collapsible-content.html">Collapsible content</a> pattern.</p>
        </div>
      </section>
    </div>
    <div id="result31" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Disclaimer overlay</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca//common-design-patterns/disclaimer-overlay.html">Disclaimer overlay</a> pattern.</p>
        </div>
      </section>
    </div>
    <div id="result32" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Download links</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/common-design-patterns/download-links.html">Download links</a> pattern.</p>
        </div>
      </section>
    </div>
    <div id="result33" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Interactive questions</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/common-design-patterns/interactive-questions.html">Interactive questions</a> pattern.</p>
        </div>
      </section>
    </div>
    <div id="result34" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Social media information</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the following patterns:</p>
          <ul>
    ...
    <div id="result35" class="hidden col-md-8 mrgn-tp-md">
      <section class="panel panel-success">
        <header class="panel-heading">
          <h2 class="panel-title"><span class="far fa-check-circle mrgn-rght-sm"></span> Contextual alerts</h2>
        </header>
        <div class="panel-body">
          <p class="mrgn-tp-md">You can use the <a href="https://design.canada.ca/common-design-patterns/contextual-alerts.html">Contextual alerts</a> pattern.</p>
        </div>
      </section>
    </div>
  </div>
  <!--<div class="row mrgn-tp-lg">
    <section class="col-md-8">
      <details>
        <summary>Feedback, questions and suggestions</summary>
        <p class="mrgn-tp-lg">Contact us at <a href="mailto:dto.btn@tbs-sct.gc.ca">dto.btn@tbs-sct.gc.ca</a> to:</p>
        <ul class="mrgn-bttm-md">
          <li>give us feedback on this wizard</li>
          <li>ask a question about a template or pattern</li>
          <li>suggest a change to improve a template or pattern</li>
          <li>contribute a missing template or pattern</li>
        </ul>
      </details>
    </section>
  </div>--> 
